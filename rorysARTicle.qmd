...
<span class="card-label">Medium, Context and Extent</span>
</a>
<a href="#section-who" class="card">
<span class="card-label">Proximity and Acceptance</span>
</a>
...
<div class="section-header-block" id="section-where">
  <h2 class="section-header" >What kinds of AI peices?</h2>
  <p class="section-subhead">Acceptance shifts dramatically depending on the medium of work and the stage of creation where AI was utilized. What people tolerate in a rough draft looks very different from what they'll accept in a finished piece.</p>
</div>
:::{.cr-section}
...
<div class="section-header-block" id="section-who">
  ...
  <p class="section-subhead">The answer changes depending on who you ask. Creators, non-creators, and AI users each draw the line in a different place — sometimes for reasons you wouldn't expect.</p>
</div>
...
<div class="section-header-block" id="section-line">
  <h2 class="section-header" >Where's the Line?</h2>
...
<div class="section-header-block" id="section-perceptions">
  <h2 class="section-header" 	>Perceptions of AI Art</h2>
  <p class="section-subhead">How AI involvement changes judgments of quality — and of creators themselves.</p>
</div>
